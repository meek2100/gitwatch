...
@test "lockfile_success: mkdir prevents a second instance from starting" {
  local output_file_1
  ...
  assert_output --partial "Error: gitwatch is already running on this repository (lockdir:"
