...
@test "notify_ignore_glob_X_combined_X_ignores_files_matching_glob_patterns_and_combines_correctly_with_x" {
  ...
  # We use --partial match and check if the debug message exists (it might not if log level is not DEBUG)
  # But assuming defaults, it should.
  # If -o DEBUG is somehow missing, this will fail.
